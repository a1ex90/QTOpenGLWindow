...
Arcball::Arcball() {
    ...
    m_zoom0 = m_zoomCur = m_zoomTar = 0.0f;
...
void Arcball::updateTransformation() {
    ...
    m_view =  QDualQuaternion(m_rotCur)* QDualQuaternion::translation(QVector3D(m_zoomCur,0,0)) * QDualQuaternion::translation(m_posCur);
}
